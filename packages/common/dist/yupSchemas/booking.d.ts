...
export declare const datesInPast = "Booking dates must not be in the past";
...
export declare const endDateValidation: import("yup/lib/string").RequiredStringSchema<string | undefined, import("yup/lib/types").AnyObject>;
